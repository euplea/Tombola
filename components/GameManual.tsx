        ...
        <div className="overflow-y-auto p-8 space-y-8 text-slate-600 leading-relaxed">
          ...
          <section className="bg-amber-50 p-6 rounded-2xl border border-amber-100">
            <h3 className="text-xl font-bold text-amber-900 flex items-center gap-2 mb-4">
              <Trophy className="text-amber-600" /> Regole di Vittoria (STRETTE)
            </h3>
            <div className="space-y-4 text-sm text-amber-900/80">
              <p>
                <strong>1. Vittoria Condivisa (Pareggio):</strong> Più giocatori possono vincere lo stesso premio (es. Ambo)
                SOLO se lo raggiungono durante la chiamata dello <strong>STESSO numero</strong>.
              </p>
              <p>
                <strong>2. Blocco dei Premi:</strong> Una volta estratto il numero successivo, il premio precedente viene "bloccato".
                Se hai fatto Ambo ma non l'hai gridato in tempo, dovrai puntare direttamente al Terno!
              </p>
              <div className="font-bold border-l-4 border-amber-400 pl-3 italic">
                "Chi tardi arriva male alloggia!" — Se l'Annunciatore chiama il prossimo numero, hai perso l'occasione.
              </div>
            </div>
          </section>
